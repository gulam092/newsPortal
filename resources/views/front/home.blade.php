...
<img class="img-responsive top_static_article_img" src="{{ asset('public/post') }}/{{ $hot_news->main_image }}"  alt="{{ $hot_news->title }}" style="height: 750px;width: 650px;" class="img-fluid">
</div>
<!-- feature_article_img -->
...
<div class="feature_article_date"><a href="{{url('/author')}}/{{$hot_news->creator->id}}" target="_self">{{$hot_news->creator->name}}</a>,<a href="#">
...
<div class="feature_article_img">
<img class="img-responsive" src="{{ asset('public/post') }}/{{ $item->main_image }}" alt="{{$item->title}}" style="height: 400px;width: 350px;">
</div>
<!-- feature_article_img -->
...
<div class="feature_article_title">
<h1><a href="{{url('/details')}}/{{$item->slug}}">
    {{str_limit($item->title,30,'..')}}</a></h1>
</div>
<!-- feature_article_title -->

<div class="feature_article_date"><a href="{{url('/author')}}/{{$item->creator->id}}" target="_self">
    {{$item->creator->name}}</a>,<a href="#">
    {{date('F j ,Y',strtotime($hot_news->created_at))}}</a></div>
<!-- feature_article_date -->

<div class="feature_article_content">
{{str_limit($item->short_description,55,'...')}}
</div>
<!-- feature_article_content -->
...
<div class="category_section mobile">
    ...
    <div class="category_article_wrapper">
        <div class="row">
          ...
          src="{{ asset('public/post') }}/{{ $item->list_image }}" alt="{{ $item->title }}" style="width: 400px; height: 240px;">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
