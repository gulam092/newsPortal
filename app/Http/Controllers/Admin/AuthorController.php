...
class AuthorController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('admin.author.list',compact('page_name','data','roles'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate($request, [ 
         ...
         'roles.*'=>'required',
           ...
           'email.email' => "Inavlid Email Format",
            'email.unique' =>'User Email Alredy Exist!',
           'password.required' => "Password at least 6 char",
           ]);
    ...
    public function destroy($id)
    {
       ...
       return redirect()->action('Admin\AuthorController@index')->with('success',"User Delete Successfully");
    }
